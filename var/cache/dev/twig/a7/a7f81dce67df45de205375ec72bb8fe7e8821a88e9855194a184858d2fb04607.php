...
class __TwigTemplate_b61e9c8eb64725328fb45388a20c59b2dc190fc378fe9f3b908a724a3a6445d7 extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    {% for entreprise in entreprises %}
        ...
        <a href=\"{{ path('show_entreprise', {'id':entreprise.id}) }}\">{{ entreprise }}</a> <br>
    {# {{ dump(entreprises) }} #}
    {% endfor %}
{% endblock %}
", "entreprise/index.html.twig", "C:\\laragon\\www\\SfEntreprise\\templates\\entreprise\\index.html.twig");
    }
}
